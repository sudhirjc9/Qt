...
#include <memory>
#include "../../findDialogBox/dialog.h"
...
void Dialog::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            using _t = void (Dialog::*)(const QString & , Qt::CaseSensitivity );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Dialog::findNext)) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (Dialog::*)(const QString & , Qt::CaseSensitivity );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Dialog::findPrevious)) {
                *result = 1;
                return;
            }
        }
...
// SIGNAL 0
void Dialog::findNext(const QString & _t1, Qt::CaseSensitivity _t2)
{
...
// SIGNAL 1
void Dialog::findPrevious(const QString & _t1, Qt::CaseSensitivity _t2)
{
    void *_a[] = { nullptr, const_cast<void*>(reinterpret_cast<const void*>(std::addressof(_t1))), const_cast<void*>(reinterpret_cast<const void*>(std::addressof(_t2))) };
